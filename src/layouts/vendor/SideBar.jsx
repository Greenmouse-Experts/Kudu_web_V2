...
export default function Sidebar({ onSelected }) {
    return (
        <div className={`h-full bg-white rounded-md flex-col w-full md:w-[22%] relative md:fixed flex overflow-auto bg-mobiDarkCloud transition-all mb-10`}>
            {/* Logo */}
            ...
            <nav className="px-4 space-y-5">
                <Link to={'/vendor/dashboard'} className={`flex items-center py-2 px-4 h-[57px] rounded-lg text-mobiRomanSilver transition`}>
                ...
                <Link to={'#'} className={`flex items-center py-2 px-4 h-[57px] rounded-lg text-mobiRomanSilver transition`}>
                    <i className="mr-3">
                        <svg width="20" height="20" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M21.5562 7.055L13.3062 2.54094C13.0858 2.41914 12.8381 2.35526 12.5862 2.35526C12.3344 2.35526 12.0867 2.41914 11.8662 2.54094L3.61624 7.05688C3.38064 7.18579 3.18396 7.37559 3.04676 7.60646C2.90956 7.83734 2.83685 8.10081 2.83624 8.36938V17.3356C2.83685 17.6042 2.90956 17.8677 3.04676 18.0985C3.18396 18.3294 3.38064 18.5192 3.61624 18.6481L11.8662 23.1641C12.0867 23.2859 12.3344 23.3498 12.5862 23.3498C12.8381 23.3498 13.0858 23.2859 13.3062 23.1641L21.5562 18.6481C21.7918 18.5192 21.9885 18.3294 22.1257 18.0985C22.2629 17.8677 22.3356 17.6042 22.3362 17.3356V8.37032C22.3361 8.10127 22.2637 7.83721 22.1264 7.6058C21.9892 7.37439 21.7923 7.18414 21.5562 7.055ZM12.5862 3.85344L20.1181 7.97844L17.3272 9.50657L9.79437 5.38157L12.5862 3.85344ZM12.5862 12.1034L5.05437 7.97844L8.23249 6.23844L15.7644 10.3634L12.5862 12.1034ZM4.33624 9.29094L11.8362 13.3953V21.4381L4.33624 17.3366V9.29094ZM20.8362 17.3328L13.3362 21.4381V13.3991L16.3362 11.7575V15.1034C16.3362 15.3024 16.4153 15.4931 16.5559 15.6338C16.6966 15.7744 16.8873 15.8534 17.0862 15.8534C17.2852 15.8534 17.4759 15.7744 17.6166 15.6338C17.7572 15.4931 17.8362 15.3024 17.8362 15.1034V10.9363L20.8362 9.29094V17.3319V17.3328Z" fill="currentColor" />
                        </svg>
                    </i>
                    <span className={`text-sm font-[500]`}>Manage Products</span>
                </Link>
                <Link to={'#'} className={`flex items-center py-2 px-4 h-[57px] rounded-lg text-mobiRomanSilver transition`}>
                    <i className="mr-3">
                        <svg width="20" height="20" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <span className={`text-sm font-[500]`}>Manage Orders</span>
                </Link>
                <a to="#" className={`flex items-center py-2 px-4 h-[57px] rounded-lg hover:bg-kuduLightGray  text-mobiRomanSilver transition`}>
                    <i className="mr-3">
                        <svg width="20" height="14" viewBox="0 0 22 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M21.7106 7.57514L17.43 1.15983C17.2937 0.954354 17.1087 0.785787 16.8915 0.669157C16.6743 0.552526 16.4316 0.491458 16.185 0.491394H2.33624C1.93842 0.491394 1.55689 0.649429 1.27558 0.930734C0.994278 1.21204 0.836243 1.59357 0.836243 1.99139V13.9914C0.836243 14.3892 0.994278 14.7707 1.27558 15.0521C1.55689 15.3334 1.93842 15.4914 2.33624 15.4914H16.185C16.4314 15.4909 16.6738 15.4298 16.891 15.3134C17.1081 15.197 17.2933 15.0288 17.43 14.8239L21.7078 8.40764C21.7905 8.28467 21.8348 8.13998 21.8353 7.99182C21.8358 7.84366 21.7924 7.69867 21.7106 7.57514ZM16.185 13.9914H2.33624V1.99139H16.185L20.1844 7.99139L16.185 13.9914Z" fill="black" />
                        </svg>
                    </i>
                    <span className="text-sm font-[500]">Manage Auctions</span>
                </a>
                <a href="#" className={`flex items-center py-2 px-4 h-[57px] rounded-lg hover:bg-kuduLightGray  text-mobiRomanSilver transition`}>
                    ...
                    <span className="text-sm font-[500]"> View Transactions </span>
                </a>
                <Link to={'#'} className={`flex items-center py-2 px-4 h-[57px] rounded-lg text-mobiRomanSilver transition`}>
                    <i className="mr-3">
                    ...
                    <span className={`text-sm font-[500]`}>Notification</span>
                </Link>
