                ...
                <div className="w-full flex flex-col xl:px-40 lg:pl-20 lg:pr-36 md:px-20 px-5 py-3 lg:gap-10 md:gap-8 gap-5 h-full bg-white">
                    <div className="relative w-full overflow-hidden Ju">
                        <div className="w-full flex flex-col gap-2 justify-center items-center mt-16">
                            <div className="flex">
                                <h1 className="text-3xl text-center font-bold md:text-2xl">Hey there, how can we help ?</h1>
                        ...
                        <div className="w-full flex md:flex-row flex-col">
                            ...
                            >
                                {/* Auction Card */}
                                <div
                                    className="h-full w-full rounded-lg p-8 flex flex-col items-center border"
                                >
                                    ...
                                    <h3 className="mt-3 text-lg font-semibold">Do you have any question ?</h3>
                                ...
                                {/* Sell Anything Card */}
                                <div
                                    className="h-full w-full rounded-lg p-6 flex flex-col items-center border"
                                >
                                    <div className="w-[80px] h-[80px]">
                                        <img
