    ...
    const users = [
        {
            ...
            description:
                " Spamming , Harassment , Illegal activities",
        },
        {
            title: "Consequences",
            description:
                ...
                <section className="breadcrumb" style={{
                    ...
                    <div className="flex flex-col py-12">
                        <div className="w-full flex flex-col xl:px-40 lg:pl-20 lg:pr-36 md:px-20 px-5 py-3 lg:gap-10 md:gap-8 gap-5 h-full">
                            <h1 className="text-4xl font-bold">Policy Statement </h1>
                        </div>
                    </div>
                </section>
                    ...
                    <div className="">
                        ...
                        <div className="text-center mt-14 mb-8">
                            <p className="text-black text-lg mb-16">
                                At KUDU, we prioritise trust, safety, and customer satisfaction. Our
                                policies ensure a secure and enjoyable shopping experience for all
                                users.
                            </p>
                        ...
                        {/*Acceptance Section */}
                        <div className="bg-white rounded-lg py-10">
                            <p className="text-black mb-8">By using [Kudu Mart Platform] users agree to these policies as contained herein.</p>
                            {acceptances.map((acceptance, index) => (
                                <div
                                    key={index}
                                    className={`border-b pb-6 mb-6 ${index === acceptance.length - 1 ? "border-b-0 mb-0 pb-0" : ""
                                        }`}
                                >
