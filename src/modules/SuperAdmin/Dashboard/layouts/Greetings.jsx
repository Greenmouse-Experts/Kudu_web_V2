...
function Greeting() {
    return (
        <div className="to-black-900 text-white px-4 py-10 md:mt-1 rounded-lg w-full" style={{
            backgroundImage: `
            ...
            <div className="flex gap-6">
                <div className="flex flex-grow gap-1">
                    <h2 className="text-lg">Welcome, Admin 👋 <br></br> <span className="text-sm leading-loose">Have a great day!</span></h2>
                    
                </div>
                <div className="flex items-center py-2 border px-5 rounded-md" style={{ width: 'fit-content' }}>
