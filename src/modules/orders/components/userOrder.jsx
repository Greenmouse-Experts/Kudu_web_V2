...
const dummyData = [
  { id: 1, orderSlug: 'ORD12345', productName: 'Laptop', createdAt: '2024-02-15T10:30:00Z', totalAmount: 120000, status: 'approved' },
  { id: 2, orderSlug: 'ORD12346', productName: 'Smartphone', createdAt: '2024-02-14T14:00:00Z', totalAmount: 80000, status: 'pending' },
  { id: 3, orderSlug: 'ORD12347', productName: 'Headphones', createdAt: '2024-02-13T09:15:00Z', totalAmount: 15000, status: 'completed' },
];
...
export default function UserOrderTable({status, loader, cancelOrder, refundOrder, refundTab}){
  // let adminOrders = useSelector((state) => state.orders.adminOrders);
       let orderData = dummyData;

    if (status) {
      orderData = dummyData.filter(where => where.status === status)
    }
