            ...
            <div className="min-h-screen w-full">
                <div className='All'>
                    ...
                    <div className="rounded-md pb-2 w-full flex justify-between gap-5">
                        <h2 className="text-lg font-semibold text-black-700 mt-4 ml-8">Create Subscription Plan</h2>
                        <MdClose className='text-[orangered] text-[30px] font-bold cursor-pointer mt-4 mr-8'
                            ...
                            >
                                <div className="w-full p-6">
                                    ...
                                    <div className="mb-4">
                                        ...
                                        />
                                        {errors.productLimit && (
                                            <p className="text-red-500 text-sm">{errors.productLimit.message}</p>
                                        )}
                                    </div>
                                    ...
                                    <div className="mb-4">
                                        ...
                                        {errors.allowsAuction && (
                                            <p className="text-red-500 text-sm">{errors.allowsAuction.message}</p>
                                        )}
                                    </div>
