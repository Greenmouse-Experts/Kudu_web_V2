            ...
            <div className="flex flex-col gap-4 border-b border-gray-300 py-4">
                <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
                    ...
                    <div className="flex md:w-[70%] items-center gap-4">
                        ...
                        {/* Product Details */}
                        <div className={`flex flex-col gap-3 ${item.product.quantity === 0 ? 'opacity-50' : ''}`}>
                    ...
                    <div className={`flex flex-col items-center gap-4 md:ml-10 ${item.product.quantity === 0 ? 'opacity-50' : ''}`}>
                        <div>
                            {(() => {
